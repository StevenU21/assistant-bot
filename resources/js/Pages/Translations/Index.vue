                    ...
                    >
                        <div class="w-full md:w-1/2">
                            ...
                            <select
                                ...
                                id="sourceLanguage"
                                class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200"
                            >
                        ...
                        <div class="flex items-center justify-center md:w-auto">
                            <button
                                ...
                                class="p-2 bg-gray-300 dark:bg-gray-700 rounded-full hover:bg-gray-400 dark:hover:bg-gray-600 focus:outline-none transition-transform duration-300"
                            >
                                <i
                                    class="fas fa-exchange-alt text-gray-700 dark:text-gray-200"
                                ></i>
                            </button>
                        </div>
                        <div class="w-full md:w-1/2">
                    ...
                    >
                        <div class="w-full md:w-1/2">
                            <textarea
                                v-model="sourceText"
                                @input="limitText"
                                class="w-full p-4 border rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 border-gray-300 dark:border-gray-600"
                                rows="10"
